...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 20 16:30:35 2020

@author: trungminh

https://pythonprogramming.net/vehicle-data-visualization-application-dash-python-tutorial/
?completed=/live-graphs-data-visualization-application-dash-python-tutorial/
"""
...
def update_graph(data_names, n):
    """
    function takes list of graphs and returns it so loop through the dict and create graph for every of it
    takes the data only for those entires that ar chosen in input
    """
